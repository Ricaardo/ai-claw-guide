...
> 只想先在 Mac 上快速装起来，不想先读完整篇？先看 [`02-OpenClaw-本地安装-macOS-一键脚本指南.md`](02-OpenClaw-本地安装-macOS-一键脚本指南.md)。
...
- **Windows**：推荐通过 WSL2 安装，详见 [`02A-OpenClaw-本地安装-Windows-一键脚本指南.md`](02A-OpenClaw-本地安装-Windows-一键脚本指南.md)
- **Linux**：详见 [`02B-OpenClaw-本地安装-Linux-一键脚本指南.md`](02B-OpenClaw-本地安装-Linux-一键脚本指南.md)
...
通用问题（npm 超时、端口占用、配置写错、模型回复为空等）请参考：[10-OpenClaw-排障与维护-通用说明.md](10-OpenClaw-排障与维护-通用说明.md)
