...
其他模型的替换方式同理，参考 [06-OpenClaw-模型配置-通用说明.md](./model-config.md)。
...
所有通用问题（command not found、npm 超时、端口占用、配置写错、模型回复为空等）请参考：[10-OpenClaw-排障与维护-通用说明.md](./troubleshooting.md)
