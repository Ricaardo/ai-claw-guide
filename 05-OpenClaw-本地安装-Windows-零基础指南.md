...
| 想先看模型怎么选 | [06-模型配置通用说明](06-OpenClaw-模型配置-通用说明.md) |
...
> 聊天渠道配置请参考 [08-OpenClaw-聊天渠道-通用说明](08-OpenClaw-聊天渠道-通用说明.md)。
...
通用排障说明：[10-OpenClaw-排障与维护-通用说明.md](10-OpenClaw-排障与维护-通用说明.md)
...
| 你想做什么 | 看哪份文档 |
|------|------|
| 配置不同的模型 | [06-OpenClaw-模型配置-通用说明](06-OpenClaw-模型配置-通用说明.md) |
| 接入飞书、Discord 等 | [08-OpenClaw-聊天渠道-通用说明](08-OpenClaw-聊天渠道-通用说明.md) |
| 安装 Skills 扩展能力 | [09-OpenClaw-Skills-安装与推荐-通用说明](09-OpenClaw-Skills-安装与推荐-通用说明.md) |
| 装好了但出错 | [10-OpenClaw-排障与维护-通用说明](10-OpenClaw-排障与维护-通用说明.md) |
