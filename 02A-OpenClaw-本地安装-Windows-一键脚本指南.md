...
想了解每一步的原理，请看完整版：[`05-OpenClaw-本地安装-Windows-零基础指南.md`](05-OpenClaw-本地安装-Windows-零基础指南.md)
...
详见 [05-OpenClaw-本地安装-Windows-零基础指南.md](05-OpenClaw-本地安装-Windows-零基础指南.md) 中的 systemd 配置章节。简要步骤：
...
| 你想做什么 | 看哪份文档 |
|------|------|
| 想了解每一步的原理 | [05-Windows 零基础指南](05-OpenClaw-本地安装-Windows-零基础指南.md) |
